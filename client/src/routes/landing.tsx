    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-4 max-w-4xl mx-auto">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-heading font-semibold text-lg tracking-tight">LeadHunter</span>
        </div>
      </nav>
      ...
      <footer className="relative z-10 border-t border-zinc-200/50 px-6 py-10">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-1 text-sm text-zinc-400">
            <img src="/logo.png" alt="LeadHunter" className="h-7 w-auto shrink-0" />
            LeadHunter &copy; {new Date().getFullYear()}
          </div>
